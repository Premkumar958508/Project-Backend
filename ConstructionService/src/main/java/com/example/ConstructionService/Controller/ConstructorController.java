...
public class ConstructorController {
    ...
    public ResponseEntity<ConstructorWithInputDto> getConstructorWithInputs(@PathVariable Long id) {
        ConstructorWithInputDto response = constructorService.getConstructorWithInputs(id);
